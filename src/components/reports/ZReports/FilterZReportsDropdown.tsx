...
// styles
import styles from "./FilterZReportsDropdown.module.css";

interface FilterZReportsDropdownProps {
  open: boolean;
...
export const FilterZReportsDropdown: FC<FilterZReportsDropdownProps> = ({
  open,
  anchorRef,
  onOpenChange,
  onSave,
